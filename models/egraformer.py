...
from models.eatten import MemoryEfficientMultiHeadedAttention
...
class GraFormer(nn.Module):
    def __init__(self, adj, hid_dim=128, coords_dim=(2, 3), num_layers=4,
                 n_head=4,  dropout=0.1, n_pts=21, use_memory_efficient=True):
        ...
        if use_memory_efficient:
            attn = MemoryEfficientMultiHeadedAttention(n_head, dim_model, dropout)
        else:
            from models.GraFormer import MultiHeadedAttention
...
# Import missing classes to make it work
